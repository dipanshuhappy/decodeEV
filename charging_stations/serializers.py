...
class ChargingStationsListQuerySerializer(serializers.Serializer):
    ...
    latitude=serializers.DecimalField(default=0,decimal_places=7,max_digits=9,required=False)
    longitude = serializers.DecimalField(decimal_places=7,max_digits=9,default=0,required=False)
